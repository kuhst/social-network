...
import { actionsUsersReducer, follow, responseUsers, unfollow } from '../../redux/UsersReducer'
import { getFollowingInProgress, getUsers, getUsersCount } from '../../redux/usersSelector'
							...
							<div style={{ marginRight: 20 }}>
								{item.followed ? (
									<Button
										...
										disabled={followingInProgress.some((userId) => userId === item.id)}>
										Unfollow
									</Button>
								) : (
									<Button
